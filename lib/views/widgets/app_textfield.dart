...
import 'package:virtualhelp_chat/views/widgets/phone_field.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: enabled ? AppColors.surfaceColor : AppColors.surfaceColor.withOpacity(0.7), // Slightly dim when disabled
      ...
      child: showPhone
          ...
          : TextFormField(
              ...
              decoration: InputDecoration(
                ...
                icon: Icon(
                  icon,
                  color: enabled ? AppColors.iconColor : AppColors.iconColor.withOpacity(0.6), // Dim icon when disabled
                  size: 24,
                ),
                hintText: hintText,
