...
class _AvatarState extends State<Avatar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
            onPressed: () => Navigator.pop(context), icon: const Icon(Icons.arrow_back_outlined, color: Colors.white)),
                    ...
                    GestureDetector(
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          decoration:
                              BoxDecoration(color: HexColor("#5953ff"), borderRadius: BorderRadius.circular(10)),
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(
                              "Continue",
  ...
  void _signUp(String email, String password, String name) async {
    ...
    Map<String, String> userInfo = {"name": name, "email": email, "password": password, "imageSvg": svg};
